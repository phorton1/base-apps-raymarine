...
DVERB, etc.) differ from the current code constants (CMD_MODIFY, CMD_COUNT, etc.).
The hex captures and observations remain valid; the naming is superseded.

Source: extracted from the OLD section of the original wpmgr.md.
